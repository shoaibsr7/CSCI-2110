...
//                we have to loop through the whole list because unlike array linked list
//                doesn't have the option to get the item in the middle
//                so, we loop through the entire list and keep updating the variable curr until we reach the required index
                curr=curr.getNext();
        }
        return curr.getData();
    }

    //method - get front node of linked list object
